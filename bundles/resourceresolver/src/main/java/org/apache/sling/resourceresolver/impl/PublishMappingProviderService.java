...
@Service(value = {MappingProvider.class, PublishMappingProviderService.class})
@Component(metatype = true)
public class PublishMappingProviderService implements MappingProvider {
    ...
    @Property(value = "/etc/map/publish",
